"""Keyword-based industry classifier for PAC names
(port of app/api/member/[id]/industryClassifier.ts).
"""
...
INDUSTRY_KEYWORDS: dict[str, list[str]] = {
    ...
    'Maritime': [
        ...
        'cargo', 'ro-ro', 'containerization', 'ballast', 'shipbreaking',
        'maritime services', 'port terminal', 'pilots',
    ],
    'Forestry': [
...
def categorize_industry(pac_name: str) -> str:
    name = pac_name.lower()
    scores: dict[str, int] = {}
